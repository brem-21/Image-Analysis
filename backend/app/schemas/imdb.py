...
WEIGHT is stored split (value+unit) for dedup/templating and rendered
...
class VLMExtraction(BaseModel):
    ...
    segment_type: str | None = Field(None, description="Market segment, e.g. Premium, Value, Economy, Mainstream")
